...
void
qsortp(void **base /* base address */, size_t n /* elements */, int (*f) ARGS((void *, void *)) /* compare function */)
{
 ...
 */
void
print_columns(struct shf *shf, int n, char *(*func) ARGS((void *, int, char *, int)), void *arg, int max_width, int prefcol)
{
